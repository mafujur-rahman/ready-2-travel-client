        ...
        <div className="bg-[#113065] my-10">
            <div className="lg:flex mx-auto container p-12 lg:gap-10">
                <div className="flex items-center mx-auto my-4 gap-5">
                    <img className="h-[100px] w-[100px]" src="/public/WishlistQucklist.png" alt="" />
                    <div>
                ...
                <div className="flex items-center mx-auto my-4 gap-5">
                    <img className="h-[100px] w-[100px]" src="/public/FreeCancellation.png" alt="" />
                    <div>
                ...
                <div className="flex items-center mx-auto gap-5">
                    <img className="h-[100px] w-[100px]" src="/public/CustomerService.png" alt="" />
                    <div>
